...
<script>
    ...
    // Hàm hiển thị form đổi mật khẩu và ẩn các form khác
    // Hàm hiển thị form đổi mật khẩu và ẩn các form khác
    ...
    function showChangeProfileForm() {
        ...
        // Hàm hiển thị form xóa tài khoản và ẩn các form khác
    function showDeleteAccountForm() {
        hideAllForms();
        document.getElementById('delete-account-form').style.display = 'block';
    }

    // Hàm hiển thị form profile và ẩn các form khác
    ...
    function hideAllForms() {
        const forms = ['profile-form', 'change-password-form', 'delete-account-form', 'change-profile-form'];
    ...
    // Khi trang tải, hiển thị mặc định form profile
    document.addEventListener('DOMContentLoaded', function () {
        showProfileForm();  // Hiển thị form thông tin cá nhân mặc định
    });
